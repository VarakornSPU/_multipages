...
function Carts({ carts, setCarts }) {
    return (<div className='carts-container'>
        ...
        <div>
            <h4>Items: <span className='badge bg-danger'>{carts.length} items</span> - Total Price: <span className='badge bg-success'>${carts.reduce((prev, cart) => { return prev + cart.price }, 0).toFixed(2)}</span></h4>
        </div>
